...
public class LoginActivity extends AppCompatActivity {
    ...
    Button btnLogin ;
    com.example.vehiclerentalapp.DBHelper DB ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DB = new com.example.vehiclerentalapp.DBHelper(this);
            ...
            public void onClick(View view) {
                ...
                if (user.equals("") || pass.equals(""))
                    ...
                    if (checkUserPass == true){
                        ...
                        Intent intent = new Intent(getApplicationContext() , com.example.vehiclerentalapp.Home.class);
